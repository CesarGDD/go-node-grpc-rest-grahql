...
type BlogServiceClient interface {
	...
	GetBlogByUserId(ctx context.Context, in *GetBlogByUserIdRequest, opts ...grpc.CallOption) (*GetBlogByUserIdResponse, error)
...
func (c *blogServiceClient) GetBlogByUserId(ctx context.Context, in *GetBlogByUserIdRequest, opts ...grpc.CallOption) (*GetBlogByUserIdResponse, error) {
	out := new(GetBlogByUserIdResponse)
	err := c.cc.Invoke(ctx, "/blogpb.BlogService/GetBlogByUserId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BlogServiceServer interface {
	...
	GetBlogByUserId(context.Context, *GetBlogByUserIdRequest) (*GetBlogByUserIdResponse, error)
...
func (UnimplementedBlogServiceServer) GetBlogByUserId(context.Context, *GetBlogByUserIdRequest) (*GetBlogByUserIdResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBlogByUserId not implemented")
}
...
func _BlogService_GetBlogByUserId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBlogByUserIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BlogServiceServer).GetBlogByUserId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blogpb.BlogService/GetBlogByUserId",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlogServiceServer).GetBlogByUserId(ctx, req.(*GetBlogByUserIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BlogService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetBlogByUserId",
			Handler:    _BlogService_GetBlogByUserId_Handler,
		},
		{
			MethodName: "GetBlogs",
